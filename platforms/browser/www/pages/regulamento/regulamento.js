jQuery(function () {
  ...
  app.request({
    url: servidor + '/api_public/institucional/regulamento.php',
    ...
    success: function (resposta) {
      ...
      if (respMerge.status == "ok") {
        ...
        $("#regulamento-text-html").append(novoTextoHTML);
      }
      else {
        ErroAjax(respMerge);
        return false;
    ...
    error: function (erro) {
      ...
      //ErroAjax('error', 'Falha em se comunicar com servidor. Por favor, tente novamente! (Cod_024)','s');
    },
  });
